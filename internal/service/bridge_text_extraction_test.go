...
func TestBridge_HandleSignalMessage_TextExtraction(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			quotedText:      "📱 447481337277: original message",
			dbLookupError:   nil,
			dbLookupResult: &models.MessageMapping{
				WhatsAppChatID: "447481337277@c.us",
			},
			expectedChatID:       "447481337277@c.us",
		...
		},
		{
			...
			quotedText:           "📱 447481337277: hello world",
		...
		},
		{
			...
			quotedText:           "📱 447481337277 missing colon",
			dbLookupError:        errors.New("not found"),
			dbLookupResult:       nil,
			expectedChatID:       "",
			expectTextExtraction: true,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bridge := NewBridge(mockWA, mockSig, mockDB, mockMedia, models.RetryConfig{}, "+12095661893", nil)
...
func TestBridge_TextExtractionLogic(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			quotedText:     "📱 447481337277: hello",
			expectedPhone:  "447481337277",
			expectedChatID: "447481337277@c.us",
			shouldExtract:  true,
		},
		{
